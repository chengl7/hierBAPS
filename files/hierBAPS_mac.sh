...
if [ "x$1" = "x" ]; then
  ...
  echo hierBAPS directory is  ${exe_dir}; 
  echo Setting up environment variables;
  MCRROOT="/Applications/MATLAB_R2014b.app"; #set your MCR installation directory here.
  ...
  cmd=${exe_dir}/${hierCmd}.app/Contents/MacOS/${hierCmd}
  cmd="${cmd} $args"
#  echo "${cmd}"
